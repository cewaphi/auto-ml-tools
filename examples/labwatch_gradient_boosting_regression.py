...
ex.observers.append(MongoObserver(
    url="127.0.0.1:27017",
    db_name="labwatch_tst"
))
ex.observers.append(FileStorageObserver('labwatch_tst'))
...
@a.search_space
def search_space():
    n_estimators = UniformInt(lower=1, upper=1000, default=250, log_scale=True)
    max_depth = UniformInt(lower=1, upper=20, default=3)
    min_samples_split = UniformInt(lower=2, upper=10, default=2)
    learning_rate = UniformFloat(lower=0, upper=1.0, default=.005)
    tags = ['gb', 'labwatch']
